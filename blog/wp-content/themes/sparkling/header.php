...
if(!isset($_SESSION['SM_login']['user_id'])){
	...
	if($_SERVER['HTTP_HOST'] == 'localhost')
		header('LOCATION: http://localhost/github/lunar/login');
	else
		header('LOCATION: http://lunar.zbraestudio.com.br/login');
							...
							<div id="logo">
								<?php echo is_home() ?  '<h1 class="site-name">' : '<p class="site-name">'; ?>
									<a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
										<!--<?php bloginfo( 'name' ); ?>-->
									  <img src="<?= get_template_directory_uri(); ?>/logo.png" id="logo">
									</a>
