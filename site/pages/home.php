  ...
  <main class="hoc container clear"> 
    ...
    <ul class="nospace group services">
      ...
      <li class="one_third btmspace-30">
        <article><a href="#"><i class="fa fa-4x fa-car"></i></a>
          <h6 class="heading font-x1">Seu carro bem cuidado</h6>
          <p>Pra cuidar de você é inevitável que seu carro esteja sendo cuidado também. Vamos ajudar você a cuidar dele.</p>
        </article>
      </li>
      <li class="one_third btmspace-30">
