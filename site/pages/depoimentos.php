...
site_setDescription('Conheça a história de algumas pessoas que melhoraram de vida depois que conheceram a Lunar.');
          ...
          <ul>
            <li>
              <article>
                ...
                <div class="comcont">
                  <p>"Comecei a dirigir depois que um amigo me mostrou a Lunar e gostei da ideia de poder ganhar dinheiro com o meu próprio carro. Depois de apenas duas semanas vi que isso era algo que eu queria fazer de forma permanente."</p>
                </div>
              </article>
            </li>
            <li>
              <article>
                ...
                <div class="comcont">
                  <p>"Eu queria algo que me fizesse sair de casa e conhecer novas pessoas. A Lunar me ajudou das duas formas e além disso, estou conhecendo algumas partes da cidade que eu nunca tinha visto antes!"</p>
                </div>
              </article>
            </li>
            <li>
              <article>
                ...
                <div class="comcont">
                  <p>"Com a Lunar eu consigo atingir meus objetivos. Posso correr atrás dos meus sonhos. Consigo compartilhar experiências musicais incríveis com o mundo."</p>
                </div>
              </article>
            </li>
          </ul>
