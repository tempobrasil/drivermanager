...
site_setDescription('Conheça todas as vantagens de você ter a ssessoria da DriverUP.');
  ...
  <div class="wrapper row3">
    <main class="hoc container clear">
      ...
      <div class="content">
        ...
        <h2>Aplicativo</h2>
        <img src="<?= get_config('SITE_URL')?>site/images/assessoria-app.jpg" class="img-right">
        <p>Pra nós, você  - Motorista Profissional - é um empresário. Até mesmo você que trabalha como renda extra, em horários esporádicos, nós olhamos pra você como alguém dono do próprio negócio. Porém sabemos que a maioria que está nessa carreira entende mesmo é de dirigir e a parte administrativa considera muito complicada. É aí que nosso aplicativo ajuda você! Nosso sistema cuida não só do dinheiro que você ganha, mas te ajuda a cuidar melhor do seu veículo e todos os investimentos que faz nele.</p>
        <p>Vamos ajudar você nessa jornada como empresário. Ajudaremos você a entender qual é seu real lucro, seus gastos com combustível, manutenção do carro, documentação, lavação, seguro, entre todas as inúmeras outras provisões do seu carro. Com nosso sistema, você será somente um motorista qualquer, mas entenderá e virá sua vida profissional – com empresa, dono do próprio negócio – crescer cada vez mais, dando ainda maior estabilidade profissional e financeira.</p>
        ...
        <h2>Blog</h2>
        <img src="<?= get_config('SITE_URL')?>site/images/assessoria-blog.png" class="img-right" style="position: relative; margin-top: -50px;">
        <p>Temos um ambiente de blog exclusivo para nossos motoristas assessorados. Lá informamos desde dicas que ajudam você a oferecer um serviço ainda mais qualificado para seus passageiros, até toda informação a respeito de tudo o que acontece no mundo dos aplicativos de transporte. Toda atualização, você fica sabendo detalhadamente o que muda pra você.</p>
        <p>E temos tudo muito organizado pra você encontrar com facilidade o que procura. Categorizado por região, aplicativo, assuntos, a navegação do nosso blog é super fácil e intuitiva, contribuindo muito pra que você esteja sempre bem informado.
        </p>
