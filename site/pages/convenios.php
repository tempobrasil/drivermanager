...
site_setDescription('Conheça quem são os parceiro da Lunar que você pode contar na sua carreira como Motorista Profissional.');
  ...
  <div class="wrapper row3">
    <main class="hoc container clear">
      ...
      <div class="content">
        ...
        <p>Abraços,<br>
          <a href="<?= GetLink('site/home'); ?>">Equipe Lunar</a></p>
        </p>
